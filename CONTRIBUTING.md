...
Ensure that your changes have passed the test suite. For more information on working with this project's tests, see https://github.com/nextlinux/sbom-action/blob/main/DEVELOPING.md#tests.
